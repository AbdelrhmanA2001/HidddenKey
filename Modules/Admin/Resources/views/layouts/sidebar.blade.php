    <div class="container-fluid page-body-wrapper">
            ...
            <div class="tab-content" id="setting-content">
                ...
                <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                    <div class="d-flex align-items-center justify-content-between border-bottom">
                        ...
                        <small class="pt-0 pb-0 pr-3 mb-3 settings-heading border-top-0 border-bottom-0 fw-normal">See
                            All</small>
                    </div>
                    <ul class="chat-list">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item nav-category">{{ __('admin::roles.roles') }}</li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false"
                        aria-controls="ui-basic">
                        <i class="menu-icon mdi mdi-floor-plan"></i>
                        <span class="menu-title">{{ __('admin::roles.roles') }}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('dashboard.role.index') }}">{{ __('admin::roles.roles') }}</a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('dashboard.role.create') }}">{{ __('admin::roles.create') }}</a></li>
                ...
                <li class="nav-item nav-category">{{ __('admin::permissions.permissions') }}</li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false"
                        aria-controls="ui-basic">
                        <i class="menu-icon mdi mdi-floor-plan"></i>
                        <span class="menu-title">{{ __('admin::permissions.permissions') }}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('dashboard.permission.index') }}">{{ __('admin::permissions.permissions') }}</a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('dashboard.permission.create') }}">{{ __('admin::permissions.create') }}</a></li>
